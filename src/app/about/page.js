  ...
  const values = [
    {
      title: "Mission",
      description:
        "To empower every glass wholesaler in India with modern, easy-to-use digital tools that simplify their daily operations.",
      icon: Target,
      color: "bg-blue-500",
    },
    {
      title: "Vision",
      description:
        "ToBe the gold standard for accounting and inventory management software in the traditional manufacturing and wholesale sectors.",
      icon: Rocket,
      color: "bg-purple-500",
    },
    {
      title: "Our Team",
      description:
        "Founded by computer science students who understand both the power of technology and the unique needs of local businesses.",
      icon: Users,
      color: "bg-orange-500",
    },
    {
      title: "Quality First",
      description:
        "We believe in building software that is fast, reliable, and secure. Performance is at the heart of everything we do.",
      icon: Award,
      color: "bg-green-500",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Karobar started with a simple observation: wholesalers were struggling with complex
            calculations and generic accounting tools. We decided to change that.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {values.map((value, index) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl ${value.color} flex items-center justify-center text-white mb-6 shadow-lg shadow-gray-200`}
              >
        ...
        <div className="bg-gradient-to-br from-primary to-blue-900 rounded-[3rem] p-8 md:p-16 text-white grid grid-cols-1 lg:grid-cols-12 gap-12 items-center shadow-2xl shadow-primary/20 relative overflow-hidden">
          ...
          <div className="lg:col-span-7 space-y-6 relative z-10">
            ...
            <div className="space-y-4 text-lg text-primary-foreground/90 leading-relaxed font-light">
              <p>
                As developers, we realized that traditional wholesale businesses were left behind by
                modern software. We saw shop owners struggling with manual registers and rigid,
                outdated ERPs that didn't fit their unique workflows.
              </p>
              <p>
                That's why we built Karobar—not just as an accounting tool, but as a growth partner.
                We designed it from the ground up to be simple, lightning-fast, and mobile-first,
                ensuring you can manage your entire business seamlessly, right from the palm of your
                hand.
              </p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-blue-50/90 italic leading-relaxed text-base font-light">
                      "Our goal is to bring the power of modern technology to every corner of the
                      traditional wholesale market. We spent months standing in noisy warehouses to
                      understand the real-world challenges, making sure our tools solve actual
                      problems."
                    </p>
                  </div>
                </div>
