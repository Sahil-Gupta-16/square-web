    ...
    <div className="pt-32 pb-24 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Have questions about features, pricing, or need help setting up? Our team is ready to
            help your business scale with Karobar.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {contactMethods.map((method, index) => (
            ...
            >
              <div>
                <div
                  className={`w-14 h-14 rounded-2xl ${method.bg} ${method.color} flex items-center justify-center mb-6`}
                >
