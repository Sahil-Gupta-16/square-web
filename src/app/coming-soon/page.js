...
const ComingSoonPage = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed font-medium">
            We're putting the final touches on the most powerful accounting tool for wholesalers.
          ...
          <div className="relative w-full max-w-md mx-auto h-2 bg-gray-100 rounded-full mb-16 overflow-hidden">
            ...
            />
            <div className="absolute -right-1 top-1/2 -translate-y-1/2 text-xs font-bold text-gray-400">
              85% Done
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-white text-xl h-16 px-10 rounded-2xl shadow-2xl shadow-primary/20 gap-3 font-bold"
              >
            ...
            <Link href="/">
              <Button
                variant="outline"
                size="lg"
                className="text-xl h-16 px-10 rounded-2xl border-2 hover:bg-gray-50 gap-3 font-bold"
              >
      ...
      <div
        className="absolute bottom-1/4 -right-20 w-80 h-80 bg-secondary/5 blur-[100px] rounded-full animate-pulse"
