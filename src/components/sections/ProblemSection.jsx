  ...
  const problems = [
    {
      ...
      description:
        "Manual calculations of glass dimensions and master units waste 3+ hours every single day.",
      icon: Clock,
    ...
    },
    {
      ...
      description:
        "Generic accounting apps don't understand SUT or master units (1/16 inch), leading to massive confusion.",
      icon: Calculator,
    ...
    },
    {
      title: "Costly Errors",
      description:
        "Inventory miscounts and invoicing errors cost wholesalers thousands of rupees every month.",
      icon: AlertTriangle,
    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            The wholesale industry has unique needs that standard software simply ignores. We built
            Karobar to solve these specific headaches.
          </motion.p>
        </div>
          ...
          {problems.map((problem, index) => (
            ...
            >
              <Card className="h-full border-none shadow-xl shadow-gray-100/50 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300">
                <CardHeader>
                  <div
                    className={`w-14 h-14 rounded-2xl ${problem.color} flex items-center justify-center mb-4`}
                  >
