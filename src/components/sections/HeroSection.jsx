          ...
          <div className="text-center lg:text-left">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <BrandMark className="h-8 md:h-10" />
                <span className="h-6 w-px bg-gray-300" />
                <span className="text-sm md:text-base font-semibold text-gray-500 tracking-wide">
                  {BRAND.tagline}
                </span>
              </div>

              <TypingAnimation
                text={`Modern Accounting for Wholesalers with ${BRAND.name}`}
              ...
              <div className="absolute inset-0 bg-gray-50 flex flex-col">
                ...
                <div className="bg-primary px-5 pt-12 pb-4 rounded-b-3xl shadow-lg relative z-10">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <h3 className="text-white font-bold text-lg leading-tight">{BRAND.name}</h3>
                ...
                <div className="flex-1 p-5 overflow-hidden flex flex-col gap-4">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-green-100 text-green-700 text-[10px] px-3 py-1 font-bold rounded-bl-xl">
                      PAID
                    </div>
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-xs">Inv #KRB-1042</p>
                      </div>
                    </div>
