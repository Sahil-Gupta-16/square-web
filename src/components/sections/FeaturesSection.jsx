...
import { Ruler, Layers, FileText, BarChart3, Smartphone, Cpu, CheckCircle2 } from "lucide-react";
...
const featureList = [
  {
    ...
    description:
      "Built-in support for Master Units (1/16 inch). No more manual conversions needed.",
    icon: Ruler,
    color: "bg-blue-500",
  },
  {
  ...
  },
  {
    ...
    description:
      "Optimized for shop floor use. Fast, responsive, and works flawlessly on any phone.",
    icon: Smartphone,
    color: "bg-red-500",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Experience the power of a tool that actually speaks your language. From master units to
            custom billing, we've got you covered.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featureList.map((feature, index) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl ${feature.color} flex items-center justify-center mb-6 text-white shadow-lg ${feature.color}/30 group-hover:rotate-6 transition-transform`}
              >
